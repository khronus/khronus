...
object Projects extends Build {
  ...
  lazy val metrikCore = Project("metrik-core", file("metrik-core"))
    ...
    .settings(libraryDependencies ++=
    compile(akkaKryo, sprayClient, sprayCan, sprayRouting, sprayJson, akkaActor, akkaRemote, akkaCluster, akkaContrib, akkaQuartz, hdrHistogram, astyanaxCore, astyanaxThrift, astyanaxCassandra, kryo, scalaLogging, slf4j, logbackClassic, commonsLang, akkaSlf4j) ++
