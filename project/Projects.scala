...
object Projects extends Build {
  ...
  lazy val khronusCore = Project("khronus-core", file("khronus-core"))
    ...
    .settings(libraryDependencies ++=
    compile(jacksonAfterBurner, jacksonScala, sprayClient, sprayCan, sprayRouting, sprayJson, akkaActor, akkaRemote, akkaCluster, akkaContrib, akkaQuartz, hdrHistogram, cassandraDriver, snappy, kryo, scalaLogging, slf4j, logbackClassic, commonsLang, akkaSlf4j, jsqlParser) ++
