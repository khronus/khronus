...
package com.searchlight.khronus.actor.cluster

import java.util.concurrent.atomic.AtomicInteger

import akka.actor._
import akka.routing._
import com.searchlight.khronus.dao.{ LeaderElection, MetaSupport }
...
class Master extends Actor with ActorLogging with RouterProvider with MetricFinder with MonitoringSupport {
  ...
  import com.searchlight.khronus.actor.cluster.Master._
  import context._
