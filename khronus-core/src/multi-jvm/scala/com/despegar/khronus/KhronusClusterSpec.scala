...
package com.despegar.khronus.com.despegar.cluster
...
import com.despegar.khronus.cluster.{RouterProvider, Master}
...
trait LocalRouterProvider extends RouterProvider {
  ...
  override def createRouter: ActorRef = {
    context.actorOf(ClusterRouterPool(RoundRobinPool(10), ClusterRouterPoolSettings(
      ...
      allowLocalRoutees = true, useRole = None)).props(com.despegar.khronus.cluster.Worker.props), "worker-router")
  }
}
